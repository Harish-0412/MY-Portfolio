    ...
    <div className="relative min-h-screen text-white overflow-x-hidden selection:bg-white/10 selection:text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-32 pb-12 flex flex-col gap-32">
        ...
        <section id="experience" className="scroll-mt-32 space-y-16">
          <div className="space-y-4">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic text-white">Experience</h2>
            <div className="h-1 w-24 bg-white" />
          </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                  ...
                  <p className="font-mono text-sm text-white/60 uppercase tracking-widest bg-white/10 px-4 py-2 rounded-full border border-white/10">
                    Duration: 1 Month
                  </p>
                </div>
              ...
              >
                ...
                >
                  ...
                  <div className={`absolute inset-0 -z-0 bg-gradient-to-br ${
                    i % 3 === 0 ? 'from-blue-600/20 to-purple-600/20' : 
